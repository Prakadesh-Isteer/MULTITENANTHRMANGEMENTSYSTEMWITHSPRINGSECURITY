...
public enum HrManagementEnum {
	...
	LEAVE_REJECTION_FAILED(9023,"LEAVE REJECTION FAILED, LEAVE ID MIGHT ALREADY APPROVED OR REJECTED"),
	...
	Leave_id_null(9822, "LEAVE ID SHOULD BE PROVIDED"),
	
	Date_Exception(9921,"PAST DATE CANNOT BE ENTERED"),
	Date_Future_exception(9972, "ENTERED DATE SHOULD NOT EXCEED BEYOND THREE DAYS FROM TODAY"),
	END_POINT_CREATED(1312,"ENDPOINT ADDED SUCCESSFULLY "),
	End_point_null(9133, "END POINT SHOULD BE PROVIDED"),
	...
	Token_malform_Exception(9231, "The JWT token is malformed and cannot be processed."),
	Token_signature_exception(9123, "Token is Invaild , Check The Signature of the Token"),
	...
	Mail_not_send(9021, "MAIL APPROVAL FAILED"),
	Mail_reject_notsend(9130,"MAIL REJECTION FAILED")
	;
